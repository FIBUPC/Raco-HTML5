...
(function (gap) {
    ...
    ChildBrowser.prototype.showWebPage = function (url, successCallback, errorCallback, external) {
        if (external) {
        ...
        var success = function (msg) {
            ...
            if (event.type == "locationChanged") {
                ChildBrowser._onLocationChange(event);
            }
        };
        ...
        gap.exec(success, error, "ChildBrowserCommand", "showWebPage", options);
    };

    ChildBrowser.prototype.openExternal = function (url) {
        gap.exec(null, null, "ChildBrowserCommand", "openExternal", {url: url});
    };

    // close the browser, will NOT result in close callback
    ChildBrowser.prototype.close = function () {
        gap.exec(null, null, "ChildBrowserCommand", "close", []);
    };
