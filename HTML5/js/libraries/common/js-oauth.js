    ...
    OAuth.prototype = {
        ...
        init: function (options) {
            ...
            this.signUrl = function(url) {
                ...
                var signatureString = toSignatureBaseString('GET', urlString, headerParams, signatureData);

                var signature = OAuth.signatureMethod[signatureMethod](oauth.consumerSecret, oauth.accessTokenSecret, signatureString);
                ...
                var signedQuery = toQueryString(headerParams);
